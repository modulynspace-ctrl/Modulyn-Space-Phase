...
export default function AdminSettings() {
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-serif font-medium text-foreground mb-2">Website Settings</h1>
        <p className="text-muted-foreground">Global site configuration and SEO settings</p>
      </div>
      ...
      <div className="bg-white border border-border rounded-xl p-12 flex flex-col items-center justify-center text-center shadow-sm min-h-[400px]">
        ...
        <h2 className="text-xl font-serif font-medium mb-2">Settings Coming Soon</h2>
